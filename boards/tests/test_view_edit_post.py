...
class PostUpdateViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.username = 'deepthi'
        self.password = 'Deepu8096'
        user = User.objects.create_user(username=self.username, email='badam.sdeepthi@gmail.com', password=self.password)
